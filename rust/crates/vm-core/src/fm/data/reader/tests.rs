...
/// 断言值来自迁移期全量位级对拍 (2832/2832) 与旧文本 基线 的等价值。
#[test]
fn parse_real_fm_files_json() {
    ...
    // 物理 FM: 顶层标量 + f32 域数值 (旧文本 基线 real_go " 11.3" 等价值)
