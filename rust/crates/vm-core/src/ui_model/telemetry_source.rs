...
pub trait TelemetrySource {
    ...
    fn get_ny(&self) -> f64; // G-Force

    fn get_vario(&self) -> f64; // Climb Rate
    ...
    fn get_roll_rate(&self) -> f64; // Wx

    fn get_energy_jkg(&self) -> f64; // Specific Energy
    ...
    fn get_manifold_pressure_pounds(&self) -> f64; // Imperial

    fn get_manifold_pressure_inch_hg(&self) -> f64; // Imperial
    ...
    // Engine Control
    fn get_unknown_mixture(&self) -> f64; // For mixture state
