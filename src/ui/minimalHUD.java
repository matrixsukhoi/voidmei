...
//		BasicStroke inBs = new BasicStroke(lineWidth, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
		...
		if(throttley >= throttleh) {
			g.setColor(app.colorShadeShape);
			g.setStroke(Bs3);
			g.drawLine(kx + barWidth, n5 - throttleh + lineWidth + 2 , kx + barWidth, n5 - throttleh + lineWidth + 2);
			g.setColor(app.colorNum);
			g.setStroke(Bs1);
			g.drawLine(kx + barWidth, n5 - throttleh + lineWidth + 2 , kx + barWidth, n5 - throttleh + lineWidth + 2);
		}
		if(throttley >= throttlec) {
			g.setColor(app.colorShadeShape);
			g.setStroke(Bs3);
			g.drawLine(kx + barWidth, n5 - throttlec + lineWidth + 2 , (int)(kx + 1.25 * barWidth), n5 - throttlec + lineWidth + 2);
			g.setColor(app.colorNum);
			g.setStroke(Bs1);
			g.drawLine(kx + barWidth, n5 - throttlec + lineWidth + 2 , (int)(kx + 1.25 * barWidth), n5 - throttlec + lineWidth + 2);
		}
		if(throttley >= throttlem) {
			g.setColor(app.colorShadeShape);
			g.setStroke(Bs3);
			g.drawLine(kx + barWidth, n5 - throttlem + lineWidth + 2 , (int)(kx + 1.5 * barWidth), n5 - throttlem + lineWidth + 2);
			g.setColor(app.colorNum);
			g.setStroke(Bs1);
			g.drawLine(kx + barWidth, n5 - throttlem + lineWidth + 2 , (int)(kx + 1.5 * barWidth), n5 - throttlem + lineWidth + 2);
		}
		if(throttley >= throttlew) {
			g.setColor(app.colorShadeShape);
			g.setStroke(Bs3);
			g.drawLine(kx + barWidth, n5 - throttlew + lineWidth + 2 , kx + barWidth + barWidth, n5 - throttlew + lineWidth + 2);
			g.setColor(app.colorNum);
			g.setStroke(Bs1);
			g.drawLine(kx + barWidth, n5 - throttlew + lineWidth + 2 , kx + barWidth + barWidth, n5 - throttlew + lineWidth + 2);
		}
