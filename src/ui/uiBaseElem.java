...
public class uiBaseElem {
	...
	public static void drawStringShade(Graphics2D g2d, int x, int y, int shadeWidth, String s, Font f) {
		__drawStringShade(g2d, x, y, shadeWidth, s, f, app.colorNum);
	}

	public static void __drawVRect(Graphics2D g2d, int x, int y, int width, int height, int borderwidth, Color c, Color Frame) {
	...
	public static void drawVBarTextNum(Graphics2D g2d, int x, int y, int width, int height, int val_height,
		...
		// 直线
		drawHRect(g2d, x, y - val_height - 1, width + 3 * numFont.getSize(), 3, 1, app.colorLabel);
		// 数字
	...
	public static void drawHBarTextNum(Graphics2D g2d, int x, int y, int width, int height, int val_width,
		...
		// 直线
		drawVRect(g2d, x + val_width - 2, y, 3, -height - 1 * numFont.getSize(), 1, app.colorLabel);
		// 数字
