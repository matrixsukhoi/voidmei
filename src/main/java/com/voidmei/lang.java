...
public class lang{
	...
	public static String dFTitle1X;
	public static String dFTitle1Y;
	public static String dFTitle2;
	public static String dFTitle2X;
	public static String dFTitle2Y;
	public static String dFTitle3;
	public static String dFTitle3X;
	public static String dFTitle3Y;
	public static String dFTitle4;
	public static String dFTitle4X;
	public static String dFTitle4Y;
...
//	public static String eFueltimeP;
	...
	public static String bWeight;
	public static String bCritSpeed;
	public static String bAllowLoadFactor;
	public static String bAverageHeatRecovery;
	public static String bNitro;
	public static String bFlapRestrict;
	public static String bEffSpeedAndPowerLoss;
	public static String bInertia;
	
	public static String bMaxLiftLoad350;
...
//			app.debugPrint(key);
	...
	public static void initLang(){
		lanuageConfig = new config("./language/cur.properties");
		
		// 挨个更新
		appName = updateLanguage("appName", appName);
		appTooltips = updateLanguage("appTooltips", appTooltips);
		close = updateLanguage("close", close);
		about = updateLanguage("about", about);
		aboutcontent = updateLanguage("aboutcontent", aboutcontent);
...
//		app.debugPrint(httpHeader);
		...
		dFnext = updateLanguage("dFnext", dFnext);
		dFTitle1 = updateLanguage("dFTitle1", dFTitle1);
		dFTitle1X = updateLanguage("dFTitle1X", dFTitle1X);
		dFTitle1Y = updateLanguage("dFTitle1Y", dFTitle1Y);
		dFTitle2 = updateLanguage("dFTitle2", dFTitle2);
		dFTitle2X = updateLanguage("dFTitle2X", dFTitle2X);
		dFTitle2Y = updateLanguage("dFTitle2Y", dFTitle2Y);
		dFTitle3 = updateLanguage("dFTitle3", dFTitle3);
		dFTitle3X = updateLanguage("dFTitle3X", dFTitle3X);
		dFTitle3Y = updateLanguage("dFTitle3Y", dFTitle3Y);
		dFTitle4 = updateLanguage("dFTitle4", dFTitle4);
		dFTitle4X = updateLanguage("dFTitle4X", dFTitle4X);
		dFTitle4Y = updateLanguage("dFTitle4Y", dFTitle4Y);
		dFTitle5 = updateLanguage("dFTitle5", dFTitle5);
		dFTitle5X = updateLanguage("dFTitle5X", dFTitle5X);
		dFTitle5Y = updateLanguage("dFTitle5Y", dFTitle5Y);
		dFTitleHZ = updateLanguage("dFTitleHZ", dFTitleHZ);
		eThrottle = updateLanguage("eThrottle", eThrottle);
		eProppitch = updateLanguage("eProppitch", eProppitch);
		...
		sTitle = updateLanguage("sTitle", sTitle);
		sWait = updateLanguage("sWait", sWait);
		sEnter = updateLanguage("sEnter", sEnter);
		sCheck = updateLanguage("sCheck", sCheck);
		vAileron = updateLanguage("vAileron", vAileron);
		...
		l3 = updateLanguage("l3", l3);
		l4 = updateLanguage("l4", l4);
		l5 = updateLanguage("l5", l5);
		l6 = updateLanguage("l6", l6);
		l7 = updateLanguage("l7", l7);
		l8 = updateLanguage("l8", l8);
		l9 = updateLanguage("l9", l9);
		l10 = updateLanguage("l10", l10);
		l11 = updateLanguage("l11", l11);
		l12 = updateLanguage("l12", l12);
		l13 = updateLanguage("l13", l13);
		l14 = updateLanguage("l14", l14);
		l15 = updateLanguage("l15", l15);
		l16 = updateLanguage("l16", l16);
		l17 = updateLanguage("l17", l17);
		l18 = updateLanguage("l18", l18);
		l19 = updateLanguage("l19", l19);
		l20 = updateLanguage("l20", l20);
		l21 = updateLanguage("l21", l21);
		l22 = updateLanguage("l22", l22);
		l23 = updateLanguage("l23", l23);
		l24 = updateLanguage("l24", l24);
		l25 = updateLanguage("l25", l25);
		l26 = updateLanguage("l26", l26);
		l27 = updateLanguage("l27", l27);
		l28 = updateLanguage("l28", l28);
		l29 = updateLanguage("l29", l29);
		l30 = updateLanguage("l30", l30);
		...
		bAoACrit = updateLanguage("bAoACrit", bAoACrit);
		bAoACritCl = updateLanguage("bAoACritCl", bAoACritCl);
		
		bFmVersion = updateLanguage("bFmVersion", bFmVersion);
		bWeight = updateLanguage("bWeight", bWeight);
		bCritSpeed = updateLanguage("bCritSpeed", bCritSpeed);
		bAllowLoadFactor = updateLanguage("bAllowLoadFactor", bAllowLoadFactor);
		bAverageHeatRecovery = updateLanguage("bAverageHeatRecovery", bAverageHeatRecovery);
		bNitro = updateLanguage("bNitro", bNitro);
		bFlapRestrict = updateLanguage("bFlapRestrict", bFlapRestrict);
		bEffSpeedAndPowerLoss = updateLanguage("bEffSpeedAndPowerLoss", bEffSpeedAndPowerLoss);
		bInertia = updateLanguage("bInertia", bInertia);
