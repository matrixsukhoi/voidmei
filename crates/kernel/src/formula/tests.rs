...
// ===== 性能实测 (ignored: 手动跑 `cargo test -p kernel --lib formula bench -- --ignored --nocapture`) =====
...
// ===== FM 查表函数族 (W1a; 与 data methods_engine 测试同 基线) =====

/// 最小 mock blkx (与 data service_loop::methods_engine::tests::spitfire_flap_blkx 同表)
