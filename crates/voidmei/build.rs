//! voidmei bin 的 Windows manifest (D9): tauri (webui) 的 comctl32 subclass 系
//! import 要求 common-controls v6 — 无 manifest 时 loader 按 v5 解析, 加载期即
//! 0xC0000139 (voidmei-probe 实证)。
//!
...
fn main() {
    ...
    // OUT_DIR = target/<profile>/build/voidmei-<hash>/out; 上溯 4 级到 target/<profile>
