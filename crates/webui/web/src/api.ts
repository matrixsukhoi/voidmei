/**
 * Rust IPC 封装 + cfg 树类型 (与 webui dto.rs 一一对应, camelCase)
 */
 ...
 * displayFmKey 配置值与 Rust HotkeyManager 绑定键全部是该域 (overlay hotkey.rs 备案);
 ...
 *  webui commands.rs get_app_version — 标题栏与更新检查同源) */
