...
//! -65535 哨兵回退分支属数据层, 已落 data::service_loop (update_compass), 不在本文件。
...
/// kernel::base::format::java_f0_exact, 重构波13 收割)
...
/// 罗盘 gauge。
/// Java 端无脏检查 (每帧直绘), Rust 侧按 overlay 组件规范补 last_value 脏检查:
