...
use kernel::base::format;
use kernel::base::format::{java_string_format, FmtArg};
use kernel::base::physics_constants::g;
use kernel::fm::data::{FmData, FmParts};
...
mod tests {
    ...
    use kernel::fm::manager::FMManager;
    ...
    struct NoFrame {}
    impl kernel::formula::registry::FormulaView for NoFrame {
