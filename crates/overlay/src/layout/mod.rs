...
impl RenderCtx {
    ...
    pub fn new(font_add: i32, column_num: i32, num_height: i32) -> Self {
        ...
        RenderCtx {
            font_size,
            label_font_size: kernel::base::format::java_round_f32(font_size as f32 / 2.0),
            unit_font_size: kernel::base::format::java_round_f32(font_size as f32 / 2.0),
            column_num,
            num_height,
        }
    }
    ...
    pub fn advance_x(&self) -> i32 {
        kernel::base::format::java_round_f32(5f32 * self.font_size as f32)
    }
